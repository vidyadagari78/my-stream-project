...
$ftpUser = "if0_42582954"
$ftpPass = "1cwyu9IIghHDF4"
$localPath = "C:\project-bolt-sb1-w4k8tvhj\project\dist"
$remotePath = "/htdocs"
...
foreach ($file in $files) {
    ...
    # Try to create directory if it's not the root htdocs
...
Write-Host "Upload complete! Files uploaded: $count/$total"
